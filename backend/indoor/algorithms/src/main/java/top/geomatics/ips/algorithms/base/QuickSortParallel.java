...
public class QuickSortParallel {
	...
	class QuickSortTask extends RecursiveTask<List<Entry<WLANFingerprint, DistanceResult>>> {
		...
		public QuickSortTask(Entry<WLANFingerprint, DistanceResult>[] entries, int low, int high) {
		...
		public void quicksort(Entry<WLANFingerprint, DistanceResult>[] a, int lo, int hi) {
			if (lo < hi - 1) {
