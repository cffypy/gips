...
import top.geomatics.ips.algorithms.knn.NNResults;
import top.geomatics.ips.algorithms.knn.NearestNeighborAlgorithm;

/**
 * The Enum PositioningAlgorithmType.
 * 
 * Defines the different types of positionig algorithms that are available. Each
 * prediction technique type has: - A name - The actual class implementing the
 * algorithm - The names of the parameters used by the technique
 * 
 * @author whudyj
 *
 */
public enum PositioningAlgorithmType {
	...
	NearestNeighbors("Nearest Neighbors", NearestNeighborAlgorithm.class, NNResults.class, new String[] { "k" }),
	...
	/**
	 * Instantiates a new prediction technique type without parameters.
	 *
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	private PositioningAlgorithmType(String algorithmName, Class positioningAlgorithm, Class resultType) {
	...
	/**
	 * Instantiates a new prediction technique type with parameters.
	 *
	 * @param name                the name of the technique
	 * @param predictionTechnique the class implementing the technique
