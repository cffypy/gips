...
public class Context {
	...
	/**
	 * Main method of the context class. Delegation of the positioning request to
	 * the configured algorithm.
	 * 
	 * @param measurements The measurement from the client
	...
	/**
	 * Additional method that can take a fingerprint instead of a measurement. First
	 * converts the fingerprint to a measurement and then calls its own
	 ...
	 * 
	 * @param positioningAlgorithm The positioning algorithm to switch to
	 */
	public void setPositioningAlgorithm(PositioningAlgorithm positioningAlgorithm) {
	 ...
	 * 
	 * @param algoType The type of algorithm
	 */
