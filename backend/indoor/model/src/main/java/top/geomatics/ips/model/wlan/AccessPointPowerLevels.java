...
public class AccessPointPowerLevels extends SignalMeasurement {
	...
	public AccessPointPowerLevels(List<Double> levels) {
		...
		this.signalMeasurements.put(SignalProperty.RSSI, new SignalMeasurementValues(levels));
	...
	private void calcAverage() {
		...
		SignalMeasurementValues levels = this.signalMeasurements.get(SignalProperty.RSSI);
	...
	public void addLevels(AccessPointPowerLevels apLvl) {
		...
		SignalMeasurementValues values = this.signalMeasurements.get(SignalProperty.RSSI);
